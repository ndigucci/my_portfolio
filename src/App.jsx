       ...
       {/* --- SKILLS --- */}
        ...
        <RevealOnScroll>
          <section id="contact" className="py-24 px-4 text-center">
            <h2 className={`text-4xl font-bold ${theme.heading} mb-8`}>Let's Connect</h2>
            <div className={`${theme.cardBg} max-w-2xl mx-auto p-8 rounded-3xl border ${theme.cardBorder} shadow-2xl relative overflow-hidden`}>
               ...
               <form action="https://api.web3forms.com/submit" method="POST" className="space-y-4 relative z-10">
                 ...
                 <input type="email" name="email" placeholder="Your Email" className={`w-full bg-transparent border ${theme.cardBorder} rounded-lg p-3 ${theme.heading} focus:border-cyan-500 outline-none transition`} required />
                 <textarea name="message" rows="4" placeholder="How can I help you?" className={`w-full bg-transparent border ${theme.cardBorder} rounded-lg p-3 ${theme.heading} focus:border-cyan-500 outline-none transition`} required></textarea>
        ...
        {/* --- FOOTER --- */}
        <footer className={`py-8 text-center text-gray-500 text-sm ${isDarkMode ? 'bg-black border-gray-900' : 'bg-slate-100 border-slate-200'} border-t`}>
          <p className="font-mono mb-2">Designed & Built by NDI GUCCI</p>
          <div className="flex justify-center gap-6 mt-4">
            <a href="https://github.com/ndigucci" target="_blank" rel="noreferrer" className="hover:text-cyan-500 transition-transform hover:-translate-y-1">GitHub</a>
            <a href="https://linkedin.com/in/ndigucci" target="_blank" rel="noreferrer" className="hover:text-cyan-500 transition-transform hover:-translate-y-1">LinkedIn</a>
            <a href="https://twitter.com/jyakuryama" target="_blank" rel="noreferrer" className="hover:text-cyan-500 transition-transform hover:-translate-y-1">Twitter</a>
            <a href="mailto:bonheurirumva43@gmail.com" className="hover:text-cyan-500 transition-transform hover:-translate-y-1">Email</a>
            <a href="https://wa.me/250785008817" target="_blank" rel="noreferrer" className="hover:text-cyan-500 transition-transform hover:-translate-y-1">WhatsApp</a>
          </div>
        </footer>
      </div>
    </>
