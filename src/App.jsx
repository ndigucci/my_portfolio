    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200 font-sans selection:bg-cyan-500 selection:text-black">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center pt-16 px-4 relative">
        <div className="text-center max-w-4xl mx-auto z-10">
          ...
          <div className="h-8 md:h-12 text-xl md:text-3xl text-gray-400 font-mono mb-8">
            <span className="text-cyan-500 mr-2">$</span>
            <Typewriter text="Pharmacy Student | AI & Cybersecurity Enthusiast" delay={50} />
      ...
      <section id="skills" className="py-24 px-4 bg-white/5">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center mb-12">
            ...
            <h2 className="px-4 text-3xl md:text-4xl font-bold text-white tracking-tight">Technical Arsenal</h2>
            <span className="h-px flex-1 bg-gray-800"></span>
          </div>
      ...
      <section id="contact" className="py-24 px-4 text-center relative overflow-hidden">
        <div className="max-w-2xl mx-auto relative z-10">
          ...
          <a 
            ...
            className="inline-block px-10 py-4 bg-transparent border-2 border-cyan-500 text-cyan-400 font-bold rounded-lg hover:bg-cyan-500/10 transition-colors"
          >
            Say Hello
          </a>
        </div>
