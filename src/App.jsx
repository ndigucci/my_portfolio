...
const certificateCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Certified Pharmacy student", 
        issuer: "NPC", 
        date: "2025", 
        image: "/pharm.jpg", 
        link: "/pharm.jpg" 
    ...
    <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                <div className="p-6 bg-[#111] border border-gray-800 rounded-xl hover:border-cyan-500/50 transition-colors duration-300 group">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Python', 'Linux (Kali)', 'AI Tools', 'Cybersecurity', 'Git','Full-Stack Software Engineer','Scalable SaaS Applications','React', 'Next.js', 'Node.js', 'Cloud & DevOps'].map(skill => <span key={skill} className="text-xs font-mono px-2 py-1 bg-gray-800 text-cyan-400 rounded border border-gray-700">{skill}</span>)}
                  </div>
                </div>
      ...
      <footer className="py-8 text-center text-gray-600 text-sm bg-black border-t border-gray-900">
        ...
        <div className="flex justify-center gap-6 mt-4">
          ...
          {/* LinkedIn Icon */}
          <a href="https://www.linkedin.com/in/irumva-bonheur-3505603a3" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-cyan-400 transition-transform hover:-translate-y-1">
       ...
       {/* Instagram Icon */}
          <a href="https://www.instagram.com/guccicleft/?hl=en" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-cyan-400 transition-transform hover:-translate-y-1">
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          {/* Discord Icon */}
          <a href="@jyakuryama" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-cyan-400 transition-transform hover:-translate-y-1">
            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
