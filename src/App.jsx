    ...
    <>
      ...
      <footer className="py-8 text-center text-gray-600 text-sm bg-black border-t border-gray-900">
        ...
        <div className="flex justify-center gap-6 mt-4">
          ...
          {/* LinkedIn Icon */}
          <a href="https://linkedin.com/in/irumva-bonheur-3505603a3" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-cyan-400 transition-transform hover:-translate-y-1">
